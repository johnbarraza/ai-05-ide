...
% 4
\begin{frame}{3. What I did: a three-type threshold audit}
\small
\begin{columns}[T,onlytextwidth]
\column{.48\textwidth}
...
\end{alertblock}
\end{columns}
\paperref{Discrete accounting extension; symbolic checks in discrete\_model.py.}
\end{frame}
...
\IfFileExists{hand/derivation.jpg}{%
  ...
  Add your own photo as \texttt{hand/derivation.jpg}, then recompile. The short copy guide is in \texttt{.me/semana\_5/}.
  \end{alertblock}
}}
\column{.44\textwidth}
